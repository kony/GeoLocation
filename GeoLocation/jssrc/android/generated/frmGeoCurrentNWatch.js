function addWidgetsfrmGeoCurrentNWatch() {
    ...
    hboxlat.add(lblLatKey, lblLatValue);
    ...
    var btnClearWatch = new kony.ui.Button({
        ...
        "id": "btnClearWatch",
        "isVisible": true,
        "onClick": p2kwiet2125006231190_btnClearWatch_onClick_seq0,
    ...
    frmGeoCurrentNWatch.add(lblDesc, hbxWatchID, lblGeoAdress, btnClearWatch);
};
...
function frmGeoCurrentNWatchGlobals() {
    frmGeoCurrentNWatch = new kony.ui.Form2({
        ...
        "needAppMenu": true,
        "onHide": p2kwiet2125006231190_frmGeoCurrentNWatch_onhide_seq0,
        "preShow": p2kwiet2125006231190_frmGeoCurrentNWatch_preshow_seq0,
