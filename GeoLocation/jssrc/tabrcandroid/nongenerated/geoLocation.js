...
function geoSuccessCallBack(position) {
    ...
    var speed;
    if (lat != null) frmGeoCurrentNWatch.lblLatValue.text = "= " + lat;
    else frmGeoCurrentNWatch.lblLatValue.text = "=unavailable.";
    if (lang != null) frmGeoCurrentNWatch.lblLongValue.text = "= " + lang;
    else frmGeoCurrentNWatch.lblLongValue.text = "=unavailable.";
    if (alt == null || isNaN(alt)) frmGeoCurrentNWatch.lblAltValue.text = "=unavailable.";
    else frmGeoCurrentNWatch.lblAltValue.text = "= " + alt;
    if (acry == null || isNaN(acry)) frmGeoCurrentNWatch.lblAccValue.text = "=unavailable.";
    else frmGeoCurrentNWatch.lblAccValue.text = "= " + acry;
    if (hedin == null || isNaN(hedin)) frmGeoCurrentNWatch.lblHeadValue.text = "=unavailable.";
    else frmGeoCurrentNWatch.lblHeadValue.text = "= " + hedin;
    if (kony.os.deviceInfo().name == "iPhone" || kony.os.deviceInfo().name == "thinclient") {
        speed = position.coords.speed;
        if (speed != null) frmGeoCurrentNWatch.lblSpeedValue.text = "= " + speed;
        else frmGeoCurrentNWatch.lblSpeedValue.text = "=unavailable."
    } else {
